...
#ifndef ORG_DESKTOP_NETWORKMANAGER_DEVICE_H
#define ORG_DESKTOP_NETWORKMANAGER_DEVICE_H
...
public:
    ...
    Q_PROPERTY(uint Ip4Connectivity READ ip4Connectivity)
    inline uint ip4Connectivity() const
    { return qvariant_cast< uint >(property("Ip4Connectivity")); }
    ...
    Q_PROPERTY(uint Ip6Connectivity READ ip6Connectivity)
    inline uint ip6Connectivity() const
    { return qvariant_cast< uint >(property("Ip6Connectivity")); }
