#ifndef WOLF_CONTROLLER_SVAS2_HANDLER_HPP
#define WOLF_CONTROLLER_SVAS2_HANDLER_HPP
...
class svas2_handler {
 public:
  ...
  svas2_handler(sensor_value_getter& value_getter);
...
#endif  // WOLF_CONTROLLER_SVAS2_HANDLER_HPP
