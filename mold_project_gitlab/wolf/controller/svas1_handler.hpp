#ifndef WOLF_CONTROLLER_SVAS1_HANDLER_HPP
#define WOLF_CONTROLLER_SVAS1_HANDLER_HPP
...
class svas1_handler {
 public:
  ...
  svas1_handler(sensor_value_getter& value_getter);
...
#endif  // WOLF_CONTROLLER_SVAS1_HANDLER_HPP
