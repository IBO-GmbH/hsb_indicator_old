#ifndef WOLF_CONTROLLER_SVAS3_HANDLER_HPP
#define WOLF_CONTROLLER_SVAS3_HANDLER_HPP
...
class svas3_handler {
 public:
  ...
  svas3_handler(sensor_value_getter& value_getter);
...
#endif  // WOLF_CONTROLLER_SVAS3_HANDLER_HPP
