#ifndef MOLD_SYNC_SENSORS_VALUES_WRITE_FRSI_HPP
#define MOLD_SYNC_SENSORS_VALUES_WRITE_FRSI_HPP
...
class frsi {
 public:
  frsi(handler& writer, options_handler& options,
 ...
 private:
  ...
  void send(const wolf::types::uuid_array& config_id, const float value);
